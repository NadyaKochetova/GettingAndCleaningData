...
* run_analysis.R file that contains the R code to generate a final dataset in the tidy.txt from the raw data provided by Coursera. See below the links to the raw data. CodeBook.md contains more details on how the data is transformed.  Note dplyr package needs to be installed to run the script successfully.
